      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto overflow-x-auto bg-[rgba(22,48,75,0.95)] backdrop-blur-md rounded-lg shadow-xl mb-20">
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="p-2 sm:p-3 bg-[rgba(18,40,65,1)] border border-white/10 text-white w-2/5 text-left text-xs font-semibold">Cleaning Tasks</th>
                <th className="p-2 sm:p-3 bg-[rgba(18,40,65,1)] border border-white/10 text-white text-center text-xs font-semibold">Standard</th>
                <th className="p-2 sm:p-3 bg-[rgba(18,40,65,1)] border border-white/10 text-white text-center text-xs font-semibold">Deep</th>
                <th className="p-2 sm:p-3 bg-[rgba(18,40,65,1)] border border-white/10 text-white text-center text-xs font-semibold">Move-In</th>
              </tr>
            </thead>
            <tbody>
              {cleaningTasks[activeTab].map((task, index) => (
                <tr key={index} className={index % 2 === 0 
                  ...
                  <td className="p-2 sm:p-3 border border-white/10 text-white text-xs">{task.task}</td>
                  <td className="p-2 sm:p-3 border border-white/10 text-center">
                    {task.routine ? <span className="text-[#dfbd69] text-base">✓</span> : <span className="text-white/30 text-base">—</span>}
                  </td>
                  <td className="p-2 sm:p-3 border border-white/10 text-center">
                    {task.deep ? <span className="text-[#dfbd69] text-base">✓</span> : <span className="text-white/30 text-base">—</span>}
                  </td>
                  <td className="p-2 sm:p-3 border border-white/10 text-center">
                    {task.moveInOut === true ? <span className="text-[#dfbd69] text-base">✓</span> : 
                     task.moveInOut === false ? <span className="text-white/30 text-base">—</span> : 
