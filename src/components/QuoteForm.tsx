...
const getFormBg = () => {
  ...
  // If it's a CSS variable, fallback to brand color
...
export default function QuoteForm() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch('https://formspree.io/f/xdkoqvgz', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...cleanFormData,
          _subject: `San Jose Maids - Quote Request from ${formData.firstName} ${formData.lastName} - #${confirmationNumber}`,
        ...
        <div className="lg:col-span-2 backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/10" style={{ background: getFormBg() }}>
          ...
          <div className="space-y-6">
            ...
            <p className="text-xs text-white/60 text-center mb-4 mt-8">
              By submitting this form, you agree to receive communications from San Jose Maids regarding your quote request. We respect your privacy and will never share your information.
            </p>
