...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    text: "I had never had an apartment cleaning before, using San Jose Maids was great. Easy to book online and my apartment is so clean!",
    date: "3 weeks ago",
...
export default function ReviewsSection({ location = "San Jose" }: ReviewsSectionProps) {
