...
export default function CarCleaningService() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes! We offer mobile car cleaning services. We'll come to your home, office, or any convenient location in San Jose and surrounding areas with all our equipment and supplies."
    },
    {
  ...
  return (
    <>
      ...
      <BaseHero 
        title="Professional Car Detailing Services in San Jose & Silicon Valley"
