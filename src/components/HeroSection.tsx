...
export default function HeroSection({ location = "San Jose" }: HeroSectionProps) {
          ...
          <div className={`text-center lg:text-left transition-all duration-500 ease-out ${
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              ...
              >
                ...
                call or text <span className="text-[#dfbd69] font-semibold ml-1 transition-all duration-300 hover:text-[#dfbd69]/80">(714) 597-6420</span>
              </a>
            </div>
