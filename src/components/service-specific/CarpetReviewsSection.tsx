...
const carpetReviews = [
  ...
  },
  {
    ...
    rating: 5,
    text: "Best carpet cleaning in San Jose! They removed years of stains and traffic patterns. Carpets look amazing!",
    date: "1 week ago",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-sm sm:text-base text-white/70 max-w-3xl mx-auto">
            See what San Jose residents say about our carpet cleaning services.
          </p>
        </div>
