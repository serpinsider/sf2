...
const commercialReviews = [
  ...
  },
  {
    id: 2,
    name: "Patricia L.",
    location: "San Jose Medical",
    rating: 5,
    text: "We run a dental practice and cleanliness is critical. San Jose Maids understands medical-grade cleaning. Highly professional team!",
    date: "2 weeks ago",
