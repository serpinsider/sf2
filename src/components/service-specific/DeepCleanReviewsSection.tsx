...
export default function DeepCleanReviewsSection() {
  const reviews = [
    ...
    },
    {
      ...
      location: "La Jolla",
      rating: 5,
      text: "Booked a deep clean before hosting family for the holidays. San Jose Maids exceeded expectations - baseboards, window sills, everything was spotless. Worth every penny!",
      date: "1 month ago",
    ...
    },
    {
      ...
      location: "Del Mar",
      rating: 5,
      text: "I get a deep clean every season and San Jose Maids never disappoints. They're consistent, reliable, and always do an amazing job. Highly recommend!",
      date: "1 week ago",
