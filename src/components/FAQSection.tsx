...
export default function FAQSection({ location = "San Jose" }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, San Jose Maids is fully insured and bonded for your peace of mind.\n\nAll our housekeepers are background-checked and trained. We carry comprehensive liability insurance to protect your home and belongings."
    },
    {
      question: "What areas do you service?",
      answer: "**San Jose & Silicon Valley:**\n• San Jose: Downtown, Willow Glen, Almaden, Evergreen, Berryessa, Cambrian, Rose Garden\n• Santa Clara County: Santa Clara, Sunnyvale, Cupertino, Mountain View, Milpitas, Campbell, Los Gatos, Saratoga\n• Surrounding Areas: Palo Alto, Fremont, Newark, Union City\n\n**Zip Codes Served:**\n• San Jose: 95101-95199\n• Santa Clara County: 95050-95056, 94085-94089, 95014, 94040-94043\n• Surrounding: 94301-94306, 94536-94560\n\nContact us to confirm service in your area."
    },
    {
      question: "How do I schedule a cleaning?",
      answer: "Get a quote or book online, or contact us directly:\n\n• Call: <a href='tel:+17145976420' class='text-[#dfbd69] hover:text-[#dfbd69]/80 font-semibold'>(714) 597-6420</a>\n• Text: <a href='sms:+17145976420' class='text-[#dfbd69] hover:text-[#dfbd69]/80 font-semibold'>(714) 597-6420</a>\n\nWe offer same-day and next-day service when available.\n\nContact us if you have questions about cleaning or handyman services.\n\n<div class='flex flex-col sm:flex-row gap-3 mt-4'><a href='/quote' class='bg-[#dfbd69] text-slate-900 px-6 py-3 rounded-lg font-semibold text-center hover:bg-[#dfbd69]/90 transition-colors'>Get A Quote</a></div>"
    },
    {
