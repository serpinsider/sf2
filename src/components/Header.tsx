    ...
    >
      <div className="relative">
        ...
        <div className="hidden lg:block">
          ...
          <div 
            className="w-full bg-transparent transition-all duration-700 ease-in-out"
            style={{
              height: effectiveScrollProgress > 0.1 ? "0" : "48px",
              opacity: effectiveScrollProgress > 0.1 ? 0 : 1,
              overflow: "hidden",
              transform: effectiveScrollProgress > 0.1 ? "translateY(-48px)" : "translateY(0)",
              pointerEvents: effectiveScrollProgress > 0.1 ? "none" : "auto"
            }}
          >
