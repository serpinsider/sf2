...
export const metadata: Metadata = {
  title: 'Terms of Service & Agreement - San Jose Maids',
  description: 'Our terms of service, service agreement, payment terms, and liability policies for house cleaning services in San Jose.',
  openGraph: {
    title: 'Terms of Service - San Jose Maids',
    description: 'Our terms of service, service agreement, and policies for house cleaning services in San Jose.',
    url: 'https://www.sanjosemaids.com/terms',
  ...
  alternates: {
    canonical: 'https://www.sanjosemaids.com/terms',
  },
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80">
              <p>San Jose Maids is fully insured and bonded. However:</p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80">
              <p>We currently serve the San Jose and Silicon Valley area, including:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>San Jose (Downtown, Willow Glen, Almaden, Evergreen, Berryessa, Cambrian)</li>
                <li>Santa Clara County (Santa Clara, Sunnyvale, Cupertino, Mountain View, Milpitas, Campbell, Los Gatos, Saratoga)</li>
                <li>Surrounding Areas (Palo Alto, Fremont, Newark, Union City)</li>
              </ul>
            </div>
          </section>
