...
export const metadata: Metadata = {
  title: 'Service Areas - San Jose Maids',
  description: 'San Jose Maids provides house cleaning services across San Jose, Santa Clara County, and surrounding Silicon Valley areas. Find your location.',
  openGraph: {
    title: 'Service Areas - San Jose Maids',
    description: 'San Jose Maids provides house cleaning services across San Jose, Santa Clara County, and surrounding Silicon Valley areas.',
    url: 'https://www.sanjosemaids.com/locations',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'San Jose Maids Service Areas',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  alternates: {
    canonical: 'https://www.sanjosemaids.com/locations',
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[var(--text-muted-light)] max-w-3xl mx-auto">
            House cleaning services across San Jose, Santa Clara County, and surrounding Silicon Valley areas. 
          ...
          {Object.entries(locationsByState).map(([state, stateLocations]) => (
            <div key={state} className="bg-white rounded-xl shadow-lg p-8">
              <h2 className="text-2xl font-serif font-bold text-[var(--text-on-light)] mb-6">
                {state === 'NY' ? 'California' : state === 'NJ' ? 'New Jersey' : 'Connecticut'}
              </h2>
