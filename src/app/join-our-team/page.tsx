...
export default function JoinOurTeamPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const applicationNumber = 'SJ-APP-' + Math.random().toString(36).substring(2, 8).toUpperCase();
      ...
      const structuredData = {
        ...
        applicationNumber,
        _subject: `San Jose Maids - Application from ${formData.firstName} ${formData.lastName} - #${applicationNumber}`,
        sourcePage: typeof window !== 'undefined' ? window.location.pathname : '',
      };

      const formspreeResponse = await fetch('https://formspree.io/f/xdkoqvgz', {
        method: 'POST',
        headers: {
        ...
        <div className="backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/10" style={{ background: 'rgba(20, 25, 30, 0.5)' }}>
          ...
          <div className="bg-white/10 rounded-lg p-6 mb-8 border border-white/20">
            ...
            <ul className="text-sm text-white/80 space-y-1">
              ...
              <li>• Work in beautiful homes across San Jose and Silicon Valley</li>
          ...
          <div className="space-y-6">
            ...
            <p className="text-xs text-white/60 text-center mt-4 leading-relaxed">
              By submitting this form, you agree to receive communications from San Jose Maids regarding your application.
              <br />
