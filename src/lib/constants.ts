...
export const LOCATION_DETAILS = {
  'sanjose01': { name: 'San Jose Maids', domain: 'sanjosemaids.com', agent: 'San Jose Team' },
  'default': { name: 'San Jose Maids', domain: 'sanjosemaids.com', agent: 'San Jose Team' }
};
...
export const PHONE_NUMBERS = {
  'sanjose01': '+17145976420',  // San Jose Maids form
  'default': '+17145976420'     // Default to San Jose Maids number
};
